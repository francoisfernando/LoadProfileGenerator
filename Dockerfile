...
RUN apt-get install -y jq python3 python3-pip python3-venv

ENV VIRTUAL_ENV=/opt/venv
ENV PATH="$VIRTUAL_ENV/bin:$PATH"
RUN python3 -m venv $VIRTUAL_ENV
RUN pip3 install pyloadprofilegenerator
...
RUN dotnet publish "SimEngine2/SimEngine2.csproj" -o /app/publish --configuration Release --self-contained true --runtime linux-x64 -f net8.0 --verbosity quiet 
